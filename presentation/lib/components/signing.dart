...
class _SigningScreenState extends State<SigningScreen> {
  ...
  void _verifySignature() {
    ...
    try {
      ...
      final isValid = flutter_monocypher.cryptoSignVerify(signatureBytes, publicKeyBytes, messageBytes);
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          maxLines: null,
          minLines: 1,
          style: const TextStyle(fontFamily: 'Courier', fontSize: 13, color: Color(0xFFE2E8F0), letterSpacing: 0.5),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildKeyTextField(label: 'Signature (64 bytes / 128 hex - editable)', controller: _signatureController),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(_isSignatureValid ? Icons.check_circle : Icons.error, color: statusColor, size: 28),
